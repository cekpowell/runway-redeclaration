...
public class LogicalRunwayParameters {
    ...
    public double getMinimumAngleOfAscentDescent(){
        return this.minimumAngleOfAscentDescent;}
    ...
    public void setMinimumAngleOfAscentDescent(double minimumAngleOfAscentDescent){
        this.minimumAngleOfAscentDescent = minimumAngleOfAscentDescent;
    }
}
