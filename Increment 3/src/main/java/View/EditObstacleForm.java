...
public class EditObstacleForm extends InputForm {
    ...
    public EditObstacleForm(){
        ...
        // disabling obstacle selection based on if obstacle is present
        ...
        this.removeObstacleButton.setOnAction((e) -> {
            ...
            boolean removeConfirmed = this.removeObstacleButton.showConfirmationWindow(formname, this.getScene().getWindow());
