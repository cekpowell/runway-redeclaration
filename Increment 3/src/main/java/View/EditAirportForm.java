...
public class EditAirportForm extends AirportInputForm {
    ...
    public EditAirportForm() {
        ...
        // disabling airport selection based on the if airports are present in the system
        ...
        this.airportSelection.setOnAction((e) -> {
            if(this.airportSelection.getValue() != null && (Airport) this.airportSelection.getValue() != this.selectedAirport) {
                ...
                runwaySelectionContainer.setDisable(this.selectedAirport.getRunways().isEmpty());
        ...
        this.removeAirportButton.setOnAction((e) -> {
            ...
            boolean removeConfirmed = this.removeAirportButton.showConfirmationWindow(formname, this.getScene().getWindow());
        ...
        this.removeRunwayButton.setOnAction((e) -> {
            // displaying confirmation window
            boolean removeConfirmed = this.removeRunwayButton.showConfirmationWindow(formname, this.getScene().getWindow());
            ...
            if(removeConfirmed){
                ...
                this.runwaySelection.setDisable(this.selectedAirport.getRunways().isEmpty());
