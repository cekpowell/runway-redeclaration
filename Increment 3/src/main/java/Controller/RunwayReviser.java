...
public class RunwayReviser {
    ...
    private static final double engineBlastAllowance = 300; // default distance allowed for engine blast during take-off
    ...
    public static RevisedLogicalRunway getRevisedLogicalRunway (LogicalRunway logicalRunway, Obstacle obstacle, ObstaclePosition obstaclePosition, FlightMethod flightMethod){
        ...
        if(flightMethod == FlightMethod.LANDING_OVER){
            ...
            alstocs = getAlsTocsLanding(logicalRunway.getParameters().getMinimumAngleOfAscentDescent(), obstacle);
        }
            ...
            alstocs = getAlsTocsTakeOff(logicalRunway.getParameters().getMinimumAngleOfAscentDescent(), obstacle);
        }
        else if(flightMethod == FlightMethod.TAKEOFF_AWAY){
            // perform calculation with taking-off away methods
    ...
    private static LogicalRunwayParameters landingOverObstacleRevision(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        double distanceLostFromPosition = obstaclePosition.getDistanceFromThreshold();
    ...
    private static LogicalRunwayParameters landingTowardsObstacleRevision(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        double distanceLostFromPosition = (parameters.getLda() - obstaclePosition.getDistanceFromThreshold());
    ...
    private static LogicalRunwayParameters takeOffTowardsObstacleRevision(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        double toraLostFromPosition = (parameters.getTora() - obstaclePosition.getDistanceFromThreshold()) - parameters.getDisplacedThreshold();
    ...
    private static LogicalRunwayParameters takeOffAwayFromObstacleRevision(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        double distanceLost = obstaclePosition.getDistanceFromThreshold() + parameters.getDisplacedThreshold() + engineBlastAllowance;
     ...
     * @return
     */
    public static Node getCalculationBreakdown(Airport airport, LogicalRunway logicalRunway, Obstacle obstacle, ObstaclePosition obstaclePosition, FlightMethod flightMethod){
        ...
        // airport
        HBox airportContainer = new HBox();
        Label airportTitleLabel = new Label("Airport : ");
        Label airportLabel = new Label(airport.getName());
        airportContainer.getChildren().addAll(airportTitleLabel, airportLabel);
        airportContainer.setAlignment(Pos.CENTER);
        airportContainer.setSpacing(20);
        ...
        runwayDetailsContainer.getChildren().addAll(runwayDetailsLabel, airportContainer, designationContainer, headingContainer, positionContainer, minimumAngleContainer);
        ...
        Label distanceFromThresholdLabel = new Label(String.valueOf(revisedLogicalRunway.getObstaclePosition().getDistanceFromThreshold()) + "(m)");
        ...
        double distanceFromCentreLine = revisedLogicalRunway.getObstaclePosition().getDistanceFromCentreLine();
    ...
    private static String landingOverObstacleBreakdown(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        calculationBreakdown += "\tThreshold Distance = " + obstaclePosition.getDistanceFromThreshold() + "(m)\n";
    ...
    private static String takeOffTowardsObstacleBreakdown(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        calculationBreakdown += "\t=(" + parameters.getTora() + "-" + obstaclePosition.getDistanceFromThreshold() + ") - " + parameters.getDisplacedThreshold() + "\n";
    ...
    private static String takeOffAwayObstacleBreakdown(LogicalRunwayParameters parameters, Obstacle obstacle, ObstaclePosition obstaclePosition){
        ...
        calculationBreakdown += "\tThreshold Distance = " + obstaclePosition.getDistanceFromThreshold() + "(m)\n";
        calculationBreakdown += "\tDisplaced Threshold = " + parameters.getDisplacedThreshold() + "(m)\n";
        calculationBreakdown += "\t=" + obstaclePosition.getDistanceFromThreshold() + "+" + engineBlastAllowance + "+" + parameters.getDisplacedThreshold() + "\n";
